            ...
            <View key={index}>
              ...
              >
                <View style={styles.checkbox}>
                  <Image style={styles.checkboxIcon} src={data.checkedPayor ? checkboxChecked : checkboxUnchecked} />
                  <Text style={styles.checkboxText}>Payor</Text>
                </View>
                <View style={styles.checkbox}>
                  <Image style={styles.checkboxIcon} src={data.checkedFamily ? checkboxChecked : checkboxUnchecked} />
                  <Text style={styles.checkboxText}>Family</Text>
                </View>
                <View style={styles.checkbox}>
                  <Image style={styles.checkboxIcon} src={data.checkedTherapist ? checkboxChecked : checkboxUnchecked} />
                  <Text style={styles.checkboxText}>Therapist</Text>
                </View>
              </View>
              {index < pdfs.length - 1 && <View style={styles.divider} />}
            </View>
          ))}
          <View>
            <Text></Text>
