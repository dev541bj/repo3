...
class TeamMemberActionsHideInactive extends React.Component {
  state = {
    anchorEl: null,
    redirect: false
  };
...
TeamMemberActionsHideInactive.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(TeamMemberActionsHideInactive);
