...
class TitleBarRatingScale extends React.Component {
  render() {
...
TitleBarRatingScale.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(TitleBarRatingScale);
