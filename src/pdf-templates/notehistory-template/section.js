            ...
            <View>
              ...
              >
                <View style={styles.radio}>
                  <Image style={styles.radioIcon} src={field.value === "Never (0%)" ? radioButtonChecked : radioButtonUnchecked} />
                  <Text style={styles.radioText}>{"Never (0%)"}</Text>
                </View>
                <View style={styles.radio}>
                  <Image style={styles.radioIcon} src={field.value === "Rarely (<50%)" ? radioButtonChecked : radioButtonUnchecked} />
                  <Text style={styles.radioText}>{"Rarely (<50%)"}</Text>
                </View>
                <View style={styles.radio}>
                  <Image style={styles.radioIcon} src={field.value === "Inconsistent (51-79%)" ? radioButtonChecked : radioButtonUnchecked} />
                  <Text style={styles.radioText}>{"Inconsistent (51-79%)"}</Text>
                </View>
                <View style={styles.radio}>
                  <Image style={styles.radioIcon} src={field.value === "Consistent (>80%)" ? radioButtonChecked : radioButtonUnchecked} />
